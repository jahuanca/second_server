...
async function getCultivosCount(req,res){
  let [err,cultivos]=await get(models.Cultivo.count({
    where:{estado: 'A'},
  }))
...
async function getCultivosByLimitAndOffset(req,res){
